 ...
 * Plugin URI: https://www.wpfabrika.com
...
class WIDGET_GH_PROFILE_CARD extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
          ...
          __('Github Profile Card', 'widget-gh-profile-card'),
          array( 'description' => __( 'Shows your github profile in detail.', 'widget-gh-profile-card' ) )
        );
    }
    ...
    public function widget( $args, $instance ) {
      ...
      echo '<div class="github-profile-card">';
        ...
        echo '<a href="'.$github_profile_url.'" title="'.__('Follow', 'widget-gh-profile-card').'" target="_blank">';
        ...
        if($show_follow_button === 'true') echo '<a class="g-follow" href="'.$github_profile_url.'" title="'.__('Follow', 'widget-gh-profile-card').'"  target="_blank">'.__('Follow', 'widget-gh-profile-card').'</a>';

        if($show_counter === 'true'){
          echo '<div class="g-profile-stats">';
            echo '<ul>';
              echo '<li><a href="'.$github_profile_url.'?tab=repositories" title="'.__('Repositories', 'widget-gh-profile-card').'" target="_blank"><span class="g-stat-title">'.__('Repositories', 'widget-gh-profile-card').'</span><span class="g-stat-count">'.$collection->public_repos.'</span></a></li>';
              echo '<li><a href="'.$github_profile_url.'?tab=followers" title="'.__('Followers', 'widget-gh-profile-card').'" target="_blank"><span class="g-stat-title">'.__('Followers', 'widget-gh-profile-card').'</span><span class="g-stat-count">'.$collection->followers.'</span></a></li>';
            echo '</ul>';
          echo '</div>';
        }
        ...
        if($show_information === 'true'){
          echo '<div class="g-details">';
            echo '<ul>';
              ...
              echo '<li><i class="fa fa-link"></i><a href="'.$collection->blog.'" title="'.__('Blog', 'widget-gh-profile-card').'" target="_blank">'.$collection->blog.'</a></li>';
            echo '</ul>';
          echo '</div>';
        }
    ...
    public function form( $instance ) {
      ...
      $title = !empty( $instance['title'] ) ? $instance['title'] : __( 'Github Profile', 'widget-gh-profile-card' );
      $github_username = $instance['github_username'];
      ...
      ?>
      <p>
        <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Widget Title', 'widget-gh-profile-card' ); ?>:</label>
        <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
      </p>

      <p>
        <label for="<?php echo $this->get_field_id( 'github_username' ); ?>"><?php _e( 'Github Username', 'widget-gh-profile-card' ); ?>:</label>
      ...
      <p>
        ...
        <label for="<?php echo $this->get_field_id( 'show_follow_button' ); ?>"><?php _e( 'Show Follow Button ?', 'widget-gh-profile-card' ); ?></label>
      </p>
      ...
      <p>
        ...
        <label for="<?php echo $this->get_field_id( 'show_counter' ); ?>"><?php _e( 'Show Counter ?', 'widget-gh-profile-card' ); ?></label>
      </p>
      ...
      <p>
        ...
        <label for="<?php echo $this->get_field_id( 'show_information' ); ?>"><?php _e( 'Show Information ?', 'widget-gh-profile-card' ); ?></label>
      </p>
      ...
      <p>
        ...
        <label for="<?php echo $this->get_field_id( 'show_desc' ); ?>"><?php _e( 'Show Description ?', 'widget-gh-profile-card' ); ?></label>
      </p>
